...
namespace Content.Shared.GameTicking
{
	...
	public TimeSpan? TimeUntilNextJoin { get; }
        public bool Paused { get; }

        public TickerLobbyStatusEvent(bool isRoundStarted, string? lobbySong, string? lobbyBackground, bool youAreReady, TimeSpan startTime, TimeSpan? timeUntilNextJoin, bool paused)
        {
            ...
            StartTime = startTime;
	    TimeUntilNextJoin = timeUntilNextJoin;
            Paused = paused;
        }
    }
